          ...
          <el-form-item class="input" v-if="ruleForm.feiyongbianhao" label="费用编号" prop="feiyongbianhao">
              <el-input v-model="ruleForm.feiyongbianhao" 
                placeholder="费用编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="年月" prop="nianyue">
          <el-input v-model="ruleForm.nianyue" 
              placeholder="年月" clearable  :readonly="ro.nianyue"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="年月" prop="nianyue">
              <el-input v-model="ruleForm.nianyue" 
                placeholder="年月" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="费用类型" prop="feiyongleixing">
          <el-input v-model="ruleForm.feiyongleixing" 
              placeholder="费用类型" clearable  :readonly="ro.feiyongleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="费用类型" prop="feiyongleixing">
              <el-input v-model="ruleForm.feiyongleixing" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `pingtaifeiyong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.pingtaifeiyongCrossAddOrUpdateFlag = false;
                  this.parent.search();
